...
export PATH="$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:/usr/local/sbin:$PATH:/opt/homebrew/bin:/opt/homebrew/Cellar/postgresql@15/15.4/bin:/opt/homebrew/opt/libpq/bin"
